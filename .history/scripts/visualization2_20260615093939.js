...
function draw_Header(svg,left,right,metric){
    ...
    .attr("text-anchor","middle").attr("font-weight","bold").attr("font-size","10px").text("Game n")

    svg.append("text").attr("x",right).attr("y",30)
    .attr("text-anchor","middle").attr("font-weight","bold").attr("font-size","10px").text("Game n+1")
