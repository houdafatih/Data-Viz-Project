...
function draw_Rows(svg,new_data,left,right,margin,r_height,scale){
    ...
    rows.append("text").attr("x",30).attr("y",5).text(d => d.eventN).attr("font-size","6px")
    rows.append("text").attr("x",left-30).attr("y",5).attr("text-anchor","end").text(d => d.current_v).attr("font-size","6px")
