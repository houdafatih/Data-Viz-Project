...
function addLegends(svg,canvas){
    ...
    lg.append("line").attr("x1",0).attr("x2",10).attr("y1",30).attr("y2",30)
    .attr("stroke","black").attr("stroke-width",2)
    lg.append("text").attr("x",11).attr("y",30).text(" = Metric").attr("font-size","5px")

    lg.append("line").attr("x1",0).attr("x2",10).attr("y1",40).attr("y2",40)
    .attr("stroke","black").attr("stroke-dasharray","6 4")
    lg.append("text").attr("x",11).attr("y",40).text(" = Baseline").attr("font-size","5px")

    lg.append("line").attr("x1",0).attr("x2",10).attr("y1",50).attr("y2",50)
    .attr("stroke-width",2).attr("stroke","#fdb927")
    lg.append("text").attr("x",11).attr("y",50).text(" = Rolling Average").attr("font-size","5px")
}