...
function createCanvas(){
    return{
        width : 500, height: 400, margin:{top: 20,right:40, bottom:60, left:50}
    }
}
...
function addLabels(svg,canvas,metric){
    ...
    .attr("text","Game Order")

    /*svg.append("text").attr("class","y-label")
    .attr("x",-canvas.height/2).attr("y",25).attr("transform","rotate(-90)")
    .attr("text-anchor","middle")
    .attr("text",metricName(metric))*/
}
