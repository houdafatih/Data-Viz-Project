...
function addLegends(svg){
    const lg = svg.append("g").attr("transform","translate(40,30)")

    lg.append("circle").attr("cx",0).attr("cy",0).attr("r",6).attr("fill","#d94801")
    lg.append("text").attr("x",15).attr("y",5).text("Hot game")

    lg.append("circle").attr("cx",120).attr("cy",0).attr("r",6).attr("fill","#999")
    lg.append("text").attr("x",135).attr("y",5).text("Normal game")

    g.append("circle").attr("cx",270).attr("cy",0).attr("r",6).attr("fill","#3182bd")
    lg.append("text").attr("x",285).attr("y",5).text("Cold game")
}