...
function addSummaryCard(svg,new_data,eventT,canvas){
    ...
    svg.append("text").attr("x",canvas.margin.left).attr("y",canvas.height-30).attr("font-size","6px")
    .text(`<strong>PTS :</strong> ${avg_pts}  FGA : ${avg_fga}  MIN : ${avg_min}  FG_PCT : ${avg_fg_pct}`)
}