...
function draw_Rows(svg,new_data,left,right,margin,r_height,scale){
    ...
    .attr("y1",50).attr("y2",50).attr("stroke","black").attr("stroke-dasharray","5 3")
    .attr("stroke-width",1.5)

    rows.append("circle").attr("cx",left).attr("cy",50).attr("r",2).attr("fill","black")
    rows.append("circle").attr("cx",right).attr("cy",50).attr("r",2).attr("fill","black")
